...
Plugin kernel for hosts that mix stores, harnesses, sessions, transports, and tools. You pass plugins in; it wires them and gives you a handle.
...
Node 18+. Plugins also export from `@buildautomaton/runtime/plugins`.
