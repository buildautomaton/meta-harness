...
export const GET_MINION_CONTEXT_DEFINITION: McpToolDefinition = {
  ...
  description:
    'Call before spawn_minion to confirm minions share this coordinator working directory. spawn_minion always waits like Task — never pass background, and do not use builtin Task/subagent tools.',
