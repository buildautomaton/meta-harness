...
import type { AgentCapabilities } from '../types/capabilities.js';
import type { LogFn } from '../types/log.js';
import { resolveAgentCommand } from '../keys/resolve-agent-command.js';
import { delayMsUnlessShutdownRequested, isShutdownRequested } from '../util/shutdown.js';
...
export async function probeOneAgentTypeForCapabilities(params: {
  ...
  const { agentType, log, signal, shouldContinue } = params;
