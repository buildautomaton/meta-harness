...
export function completeSessionRow(db: Database, sessionId: string, artifactId: string): void {
  const now = isoNow();
  run(
    db,
...
export function listSessionRows(db: Database, workId: string): WorkSessionLink[] {
