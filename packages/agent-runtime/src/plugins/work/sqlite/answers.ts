...
export function saveAnswers(db: Database, artifactId: string, answers: QuestionAnswer[]): AnswerQuestionsResult {
...
function persistAnswer(db: Database, artifactId: string, answer: QuestionAnswer, row: QuestionRow): void {
  run(
    db,
