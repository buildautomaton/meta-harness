...
export function formatDrafts(sessionId: string, drafts: WorkItem[]): string {
  ...
  return [
    ...
    'Call ask_interview_questions with workId, this sessionId, and 2–4 multiple-choice questions.',
...
export const NO_ARTIFACTS =
  'Provide at least one artifact kind: ui, api, algorithm, dataModel, moduleStructure, backend, or outline.';
