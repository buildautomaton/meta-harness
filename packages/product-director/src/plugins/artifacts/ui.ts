...
import { embedAssetsInHtml } from '@plugins/work/artifacts/embed-assets.js';
import { UI_ARTIFACT_SCHEMA } from '@plugins/work-tools/schema/ui.js';
import { UI_INSTRUCTIONS } from '@plugins/work-tools/schema/ui-copy.js';
