...
import { algorithmHtml, algorithmMarkdown } from '@plugins/work/artifacts/algorithm-pages.js';
import { ALGORITHM_ARTIFACT_SCHEMA } from '@plugins/work-tools/schema/algorithm.js';
import { parseNamed } from '@plugins/work-tools/parse-parts.js';
