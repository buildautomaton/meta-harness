export const UI_PAGES_DESCRIPTION =
  'One HTML preview per changed UI surface. A surface is a full screen, or a single component when the change was smaller. Preview only, in the app design system, with realistic mock data. Visually highlight what changed versus before. The review questionnaire is the separate questions.ui param — the HTML does not need to include it.';
...
export const UI_HTML_DESCRIPTION = [
  ...
  'Highlight the change visually (callout, badge, before/after, or annotated region).',
...
export const UI_CHANGED_DESCRIPTION =
  'What changed on this surface versus before. Also highlight those changes visually in the HTML.';
