...
export function replaceWorkQuestions(db: SqlStore, workId: string, questions: DesignQuestion[]): void {
...
export function saveWorkAnswers(db: SqlStore, workId: string, answers: QuestionAnswer[]): InterviewAnswer[] {
