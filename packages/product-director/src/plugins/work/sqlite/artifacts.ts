...
export function insertArtifactFiles(db: SqlStore, artifactId: string, files: ArtifactFile[]): void {
...
export function listArtifactSummaries(db: SqlStore, workId?: string): WorkArtifactSummary[] {
  const rows = workId
...
export function loadArtifact(db: SqlStore, id: string): WorkArtifact | null {
